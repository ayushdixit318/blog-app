  ...
  return (
    <div className="flex min-h-[calc(100vh-100px)] items-center justify-center py-12 px-4">
      ...
      >
        ...
        >
          <h1 className="text-3xl font-black bg-gradient-to-r from-slate-900 to-blue-700 bg-clip-text text-transparent">Welcome back</h1>
        ...
        >
          Don't have an account? <Link className="font-semibold text-blue-600 hover:text-blue-700" to="/register">Create one</Link>
        </motion.p>
      </motion.div>
    </div>
  );
